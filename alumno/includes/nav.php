        ...
        <ul class="treeview-menu">
          <?php if($row > 0){
              ...
              ?>
                ...
                <li><a class="treeview-item" href="../logout.php"></i><span class="app-menu__label">FORO</span></a></li>
                <li><a class="treeview-item" href="laboratorios.php"></i><span class="app-menu__label">AYUDA LABORATORIOS</span>
              </a></a></li>
